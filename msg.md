How can i fix
 ...
 >>> referenced by xps-glyphs.c
 >>>               xps-glyphs.o:(xps_lookup_font) in archive /data/data/com.termux/files/usr/lib/libmupdf.a
 >>> referenced by pdf-font.c
 >>>               pdf-font.o:(pdf_load_simple_font) in archive /data/data/com.termux/files/usr/lib/libmupdf.a

 ld.lld: error: undefined symbol: FT_Get_Char_Index
 >>> referenced by xps-glyphs.c
 ...
 >>>               font.o:(do_ft_render_glyph) in archive /data/data/com.termux/files/usr/lib/libmupdf.a
 >>> referenced by font.c
 >>>               font.o:(do_ft_render_glyph) in archive /data/data/com.termux/files/usr/lib/libmupdf.a
 >>> referenced 2 more times

 ld.lld: error: undefined symbol: hb_buffer_clear_contents
 >>> referenced by html-layout.c
 >>>               html-layout.o:(walk_string) in archive /data/data/com.termux/files/usr/lib/libmupdf.a